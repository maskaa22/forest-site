  ...
  return (
    ...
    <div className='benefit' id='benefit'>
      ...
      <div className='about-image height100'>
          <img src={'./img/benefit-img.jpg'} className='height100 benefit-img-left'/>
          <img src={'./img/green-forest.jpg'} className='benefit-img-anim-1'/>
          <img src={'./img/yellow-forest.jpg'} className='benefit-img-anim-2'/>
        </div>
